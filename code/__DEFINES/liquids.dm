...
#define REQUIRED_FIRE_POWER_PER_UNIT 3
...
#define PICK_WATER_WADE_NOISES pick('sound/effects/liquids/water_wade1.ogg', 'sound/effects/liquids/water_wade2.ogg', 'sound/effects/liquids/water_wade3.ogg', 'sound/effects/liquids/water_wade4.ogg')
...
#define LIQUIDS_ACCELERANT_BURN_RATE 0.5
#define LIQUIDS_ACCELERANT_BURN_POWER_MULTIPLIER 0.4
