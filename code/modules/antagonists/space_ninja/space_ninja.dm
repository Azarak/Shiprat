...
/datum/antagonist/ninja/on_gain()
	...
	owner.current.mind.set_assigned_role(SSjob.get_job_by_type(/datum/job/space_ninja))
	owner.current.mind.special_role = ROLE_NINJA
	return ..()

/datum/antagonist/ninja/admin_add(datum/mind/new_owner,mob/admin)
	new_owner.set_assigned_role(SSjob.get_job_by_type(/datum/job/space_ninja))
